...
public static class IdentityExtensions
{
    ...
    /// <summary>
    /// Method Gets Currently Logged In Users' Username Value.
    /// </summary>
    /// <param name="user">Defines Users Claims To Be Processed.</param>
    /// <returns>Currently Logged In Users' Username Value.</returns>
    public static string GetUserName(this ClaimsPrincipal user) =>
        user.Claims.FirstOrDefault(x => x.Type == "aspnet.username")?.Value ?? user.Claims.FirstOrDefault(x => x.Type == ClaimTypes.Email)!.Value;
