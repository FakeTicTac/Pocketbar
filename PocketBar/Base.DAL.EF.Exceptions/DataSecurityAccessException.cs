...
/// <summary>
/// Class Defines Exception For Data Security Access In Database Layer Issues.
/// </summary>
public class DataSecurityAccessException : Exception
{

    /// <summary>
    /// Basic Parameterless Constructor. 
    /// </summary>
    public DataSecurityAccessException() { }
    ...
    public DataSecurityAccessException(string message) : base(message) { }
    ...
    public DataSecurityAccessException(string message, Exception inner) : base(message, inner) { }
    ...
    protected DataSecurityAccessException(System.Runtime.Serialization.SerializationInfo info,
