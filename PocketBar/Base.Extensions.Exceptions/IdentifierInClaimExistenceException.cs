...
/// </summary>
public class IdentifierInClaimExistenceException : Exception
{
    ...
    public IdentifierInClaimExistenceException(string message, Exception inner) : base(message, inner) { }
