...
var dbConnectionString = "Host=localhost;Port=5432;Username=postgres;Password=postgres;database=PocketBar";

System.Diagnostics.Trace.TraceInformation("@@@@@@@@@@@@@@@@@@@@@@@@");
System.Diagnostics.Trace.TraceInformation(dbConnectionString);
System.Diagnostics.Trace.TraceInformation("@@@@@@@@@@@@@@@@@@@@@@@@");
