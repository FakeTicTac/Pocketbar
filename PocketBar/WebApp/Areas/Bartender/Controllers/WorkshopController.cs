...
namespace WebApp.Areas.Bartender.Controllers;


/// <summary>
/// Workshop Page Controller Implementation.
/// </summary>
[Authorize]
[Area("Bartender")]
public class WorkshopController : Controller
{
    ...
    /// <summary>
    /// Workshop Page Controller Controller Constructor. Defines Generic Logging Interface.
    /// </summary>
    /// <param name="logger">Generic Logging Interface</param>
    public WorkshopController(ILogger<HomeController> logger) => _logger = logger;
